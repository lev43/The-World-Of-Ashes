const multiLib = require("Sapphirium/multi-lib");
...
const multi = multiLib.MultiCrafter(GenericCrafter, GenericCrafter.GenericCrafterBuild, "freezer", [
    {
      ...
      output: {
        items: ["smokeofanarchy_modpack-ice-cube/3"]
      },
      craftTime: 80
    },
    {
          ...
          output: {
            items: ["smokeofanarchy_modpack-cryocube/5"]
          },
          craftTime: 95
        },
        {
          ...
          output: {
            items: ["smokeofanarchy_modpack-cinderblock/4"]
          },
          craftTime: 120
        },
        {
        ...
        {
        input: {
            liquids: ["smokeofanarchy_modpack-surge-mass/12"]
          },
          output: {
            items: ["smokeofanarchy_modpack-surge-stone/2"]
          },
          craftTime: 125
        },
], {
  ...
  function Extra() {
    this.draw=function(){
      let region1 = Core.atlas.find("freezer-top")
      Draw.rect(region1, this.x, this.y);
      let region2 = Core.atlas.find("freezer")
...
const items = require("Sapphirium/items");
...
const sectors = require("Sapphirium/sectors");
